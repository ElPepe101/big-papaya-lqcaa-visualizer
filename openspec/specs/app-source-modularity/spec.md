# app-source-modularity Specification

## Purpose

TBD — source layout conventions for the LQCAA OpenFrameworks app after modularizing `ofApp` into multiple translation units.
