...
Three-dimensional meter view: 16 channels on a sphere in a 4×4 patch grid, orthographic camera with fixed-up orbit, HSL/HSB lightness from level, opaque fills.
