# world-wall-noise-grid-display Specification

## Purpose

Normative behavior for the primary three-dimensional 16-channel meter: a world-fixed wall grid with vertex-shader-only normal-direction noise, grayscale level modes, opaque fills, no bread/PBR/HDRI required by default, and unchanged audio I/O. This capability supersedes `plane-3d-channel-display` for primary UX.
